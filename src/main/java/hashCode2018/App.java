...
public class App 
{
    public static void main( String[] args ){
        ...
        String filepath = "/home/ringo/Bureau/hashCode2018/e_high_bonus.in";
        int points = 0;
...
//        }
        ...
        int cpt = 0;
        for(Trajet t : tabloTrajet){
            if(!t.done){
                cpt++;
            }
        }
        System.out.println("Total trajet -> " + tabloTrajet.size());
